...
var yomotsuRollover = {
	...
	main : function() {
		var img = document.img, ipt = document.getElementsByTagName('input'), i, preLoadImg = [];
		// img elements
		...
		for (i = 0; i <ipt.length; i++) {
			if ((ipt[i].src.match(/.*_n\./))&&(ipt[i].getAttribute('type')=='img')){
				preLoadImg[preLoadImg.length] = new Image;
				preLoadImg[preLoadImg.length-1].src = ipt[i].src.replace('_n.', '_o.');
